...
DESKTOP_SHARED_LOGIN_EMAIL = _env("DESKTOP_SHARED_LOGIN_EMAIL", "desktop-team@example.com")
DESKTOP_SHARED_LOGIN_PASSWORD = _env("DESKTOP_SHARED_LOGIN_PASSWORD", "Team123456!")
