...
OPENCLAW_TIMEOUT_MS = int(_env("OPENCLAW_TIMEOUT_MS", "45000"))
OPENCLAW_CLIENT_ID = _env("OPENCLAW_CLIENT_ID", "chonggou-backend")
OPENCLAW_CLIENT_MODE = _env("OPENCLAW_CLIENT_MODE", "webchat")
