...
_LOCAL_ASSISTANT_DATA_ROOT = _LOCAL_RUNTIME_ROOT / "assistant_data"
_DEFAULT_OPENCLAW_WORKSPACE = _LOCAL_ASSISTANT_DATA_ROOT / "openclaw_workspace"
_DEFAULT_OPENCLAW_STATE = _LOCAL_ASSISTANT_DATA_ROOT / "openclaw_state"
...
GEMMA_PROVIDER_MODEL_ID = _env("GEMMA_PROVIDER_MODEL_ID", "gemma-4-31b-it")
GEMMA_PROVIDER_BRIDGE_BASE_URL = _env("GEMMA_PROVIDER_BRIDGE_BASE_URL", "http://127.0.0.1:8000/gemma-provider/v1")
GEMMA_PROVIDER_UPSTREAM_BASE_URL = _env("GEMMA_PROVIDER_UPSTREAM_BASE_URL", "http://127.0.0.1:19010/v1")
GEMMA_PROVIDER_CONTEXT_WINDOW = int(_env("GEMMA_PROVIDER_CONTEXT_WINDOW", "8192"))
GEMMA_PROVIDER_OUTPUT_CAP = int(_env("GEMMA_PROVIDER_OUTPUT_CAP", "768"))
GEMMA_PROVIDER_PUBLIC_CONTEXT_WINDOW = int(_env("GEMMA_PROVIDER_PUBLIC_CONTEXT_WINDOW", "32768"))
GEMMA_PROVIDER_PUBLIC_MAX_TOKENS = int(_env("GEMMA_PROVIDER_PUBLIC_MAX_TOKENS", "2048"))
GEMMA_PROVIDER_REQUEST_TIMEOUT_SEC = float(_env("GEMMA_PROVIDER_REQUEST_TIMEOUT_SEC", "600"))
GEMMA_PROVIDER_REMOTE_HTTP_BASE_URL = _env("GEMMA_PROVIDER_REMOTE_HTTP_BASE_URL", "http://127.0.0.1:18000/v1")
GEMMA_PROVIDER_REMOTE_SSH_HOST = _env("GEMMA_PROVIDER_REMOTE_SSH_HOST", "10.101.0.36")
GEMMA_PROVIDER_REMOTE_SSH_PORT = int(_env("GEMMA_PROVIDER_REMOTE_SSH_PORT", "2222"))
GEMMA_PROVIDER_REMOTE_SSH_USER = _env(
    "GEMMA_PROVIDER_REMOTE_SSH_USER",
    "v6yvdcnv#root#bec2604c-ae04-4222-85f3-b399f6ab2e51",
)
GEMMA_PROVIDER_REMOTE_SSH_PASSWORD = _env("GEMMA_PROVIDER_REMOTE_SSH_PASSWORD", "Qingbei36974!")
ASSISTANT_DUPLEX_PROVIDER = _env("ASSISTANT_DUPLEX_PROVIDER", "MiniCPM-o-4.5")
ASSISTANT_DUPLEX_WS_BASE = _env("ASSISTANT_DUPLEX_WS_BASE", "ws://127.0.0.1:19002/ws/duplex")
ASSISTANT_DUPLEX_AUDIO_CHUNK_MS = int(_env("ASSISTANT_DUPLEX_AUDIO_CHUNK_MS", "1000"))
ASSISTANT_DUPLEX_SAMPLE_RATE = int(_env("ASSISTANT_DUPLEX_SAMPLE_RATE", "16000"))
ASSISTANT_DUPLEX_TRANSPORT = _env("ASSISTANT_DUPLEX_TRANSPORT", "native_ws_proxy")
