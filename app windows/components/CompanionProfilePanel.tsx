              ...
              <div className="mt-6 grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-6">
                <div className="rounded-3xl ios-stage-panel p-6">
                  ...
                  <div className="mt-5 space-y-3 text-sm text-slate-300">
                    <div>
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">名字</div>
                      <div className="mt-1 text-xl font-black text-white">
                        {activation.preferred_name || "未确认"}
                      </div>
                    </div>
                    <div>
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">一句介绍</div>
                      <div className="mt-1 leading-7">
                        {activation.voice_intro_summary || "尚未补充"}
                      </div>
                    </div>
                    <div>
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">摘要</div>
                      <div className="mt-1 leading-7">
                ...
                <div className="rounded-3xl ios-stage-panel p-6">
                  ...
                  <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="rounded-2xl ios-metric-card px-4 py-4">
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">状态</div>
                      <div className="mt-2 text-lg font-black text-white">
                        {assessment.assessment_ready ? "已完成" : "待完成"}
                      </div>
                    </div>
                    <div className="rounded-2xl ios-metric-card px-4 py-4">
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">有效回答</div>
                      <div className="mt-2 text-lg font-black text-white">
                        {assessment.conversation_count}
                      </div>
                    </div>
                    <div className="rounded-2xl ios-metric-card px-4 py-4">
                      <div className="text-[11px] font-semibold tracking-[0.18em] text-slate-500">稳定度</div>
                      <div className="mt-2 text-lg font-black text-white">
