...
export function buildAgentSystemPrompt(params: {
  ...
  const heartbeatPromptLine = heartbeatPrompt ? `Heartbeat prompt: ${heartbeatPrompt}` : undefined;
  ...
  // Include heartbeat acknowledgements only for explicit heartbeat runs.
  if (!isMinimal && heartbeatPromptLine) {
    lines.push(
      "## Heartbeats",
      heartbeatPromptLine,
