...
try {
  ...
  $expected = @(
    ...
    (Join-Path $probeRoot "resources\openclaw\docs\reference\templates\AGENTS.md"),
    (Join-Path $probeRoot "resources\openclaw\docs\reference\templates\IDENTITY.md"),
    (Join-Path $probeRoot "resources\openclaw\docs\reference\templates\SOUL.md"),
    (Join-Path $probeRoot "resources\openclaw\docs\reference\templates\USER.md"),
